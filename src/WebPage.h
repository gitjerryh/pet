...
<body>
    <div class="page-container">
        ...
        <div class="content-container">
            ...
            <div class="controls-container">
                ...
                <div class="button-grid">
                    <button class="button button4" id="actionA" onclick="fetch(document.location.origin+'/control?var=funcMode&val=5&cmd=0');">ActionA</button>
    ...
    document.addEventListener('DOMContentLoaded', function (event) {
        ...
        var piStreamUrl = 'http://192.168.107.172:8000/video_feed';
